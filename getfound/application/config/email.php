...
$config['smtp_host']    = "host316.hostmonster.com";                // SMTP Server Address. ( None )
$config['smtp_user']    = "contact@getfound.ly";                // SMTP Username. ( None )
$config['smtp_pass']    = "ames1987";                // SMTP Password. ( None )
